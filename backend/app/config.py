...
class BaseConfig:
    ...
    # MySQL 数据库
    DB_USER = os.environ.get('DB_USER', 'traffic_user')
    DB_PASSWORD = os.environ.get('DB_PASSWORD', 'traffic_pass123')
    ...
    SOCKETIO_ASYNC_MODE = os.environ.get('SOCKETIO_ASYNC_MODE', 'threading')  # threading/gevent/eventlet
...
class DevelopmentConfig(BaseConfig):
    ...
    # 开发环境使用 MySQL（root/123456）
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        'DEV_DATABASE_URL',
        'mysql+pymysql://root:123456@127.0.0.1:3306/traffic_training?charset=utf8mb4'
    )
    # MySQL 使用连接池
    SQLALCHEMY_ENGINE_OPTIONS = {
        'pool_size': 5,
